...
def import
  Cells.import(params[:file])
  redirect_to root_url, notice: "Cells added successfully"
  # redirect_to cells_path, notice: "Cells added successfully"
end 
  ...
  private
    ...
    def cell_params
      params.require(:cell).permit(:names, :Cell, :CD22)
    end
end
